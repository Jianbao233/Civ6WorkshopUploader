...
* `image.png`     -- Optional workshop preview image (PNG, ideally square, <= 1 MB).
                      Uploaded when present; skipped otherwise (matches Civ6's official
                      uploader, where the preview image is not required).
